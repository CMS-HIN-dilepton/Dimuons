...
#castorDirIn="/castor/cern.ch/cms/store/caf/user/tdahms/HeavyIons/Onia/Data2010/v4/Skims/Prompt/150256-150619/"
castorDirOut="/castor/cern.ch/cms/store/user/tdahms/HeavyIons/Onia/Data2010/v4/Histos/Prompt/150256-150619/h4/"
...
for fileList in `ls inputOniaSkim_v2_???`
do
    echo $fileList;
...
#Start to write the script
	cat > job_hionia_v2_${jobNb}.sh << EOF
#!/bin/sh
...
EOF
	...
	chmod 755 job_hionia_v2_${jobNb}.sh
	
	bsub -q 1nd -J $name /afs/cern.ch/user/t/tdahms/scratch0/HeavyIons2010/CMSSW_3_9_9_patch1/src/HiAnalysis/HiOnia/test/job_hionia_v2_${jobNb}.sh
