#include "Onia/Chi2OniaGamma/interface/MyCommonHistoManager.h"
...
void MyCommonHistoManager::Fill(const pat::Candidate *p, string theFullName) {
...
void MyCommonHistoManager::Fill(const pat::Candidate *p1, const pat::Candidate *p2, string theFullName, string theName2) {
...
void MyCommonHistograms::Fill(const pat::Candidate *p) {
  ...
  hCent_Mass->Fill(p->mass(), p->centrality());
  return;
}

void MyCommonHistograms::Fill(const pat::Candidate *p1, const pat::Candidate *p2, string hName2) {
