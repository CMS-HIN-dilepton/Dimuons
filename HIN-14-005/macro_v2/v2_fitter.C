...
void v2_fitter(int jpsiCategory = 3, // 2 : Prompt, 3 : Non-Prompt
               int varCategory  = 4, // 1: pt; 2: rapidity; 3: centrality; 4: integrated
               int nDphiBins    = 4,
               ...
               bool bSavePlots = true)
{
  ...
  const char* signal[5]      = {"","","Prp","NPrp","NBkg"};
  const char* legend[5]      = {"","","Prompt J/#psi","Non-prompt J/#psi","Background"};
  ...
  // prompt bins
  double ptBins[]    = {3.0, 6.5, 8.0, 10, 30.0};
  ...
  default://minbias
    cout<<"You are calculating the integrated bin!"<<endl;
    if(jpsiCategory==2) {
      phV2    = new TH1F("phV2_pr",";Integrated Bin;",nBins,centBins_int);
      phV2Cor = new TH1F("phV2Cor_pr",";Integrated Bin;",nBins,centBins_int);
    } else if(jpsiCategory==3) {
      phV2    = new TH1F("phV2_np",";Integrated Bin;",nBins,centBins_int);
      phV2Cor = new TH1F("phV2Cor_np",";Integrated Bin;",nBins,centBins_int);
    }
