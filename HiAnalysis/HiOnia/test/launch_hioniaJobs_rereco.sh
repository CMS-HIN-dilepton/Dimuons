...
logDir=${workDir}"/BATCHJOBS/v7.h0/"
command "mkdir -p $logDir"

castorDirIn="/castor/cern.ch/cms/store/user/tdahms/HeavyIons/Onia/Data2010/v7/Skims/ReReco/"
castorDirOut="/castor/cern.ch/cms/store/user/tdahms/HeavyIons/Onia/Data2010/v7/Histos/ReReco/h0/"
...
EOF
	...
	bsub -q 2nw -J $name /afs/cern.ch/user/t/tdahms/scratch0/HeavyIons2010/CMSSW_3_9_9_patch1/src/HiAnalysis/HiOnia/test/job_hionia_rereco_${jobNb}.sh
