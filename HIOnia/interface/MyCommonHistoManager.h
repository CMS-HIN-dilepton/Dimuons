...
class MyCommonHistoManager {
 public:
  ...
  void Fill(const pat::Candidate *p, string theFullName);
  void Fill(const pat::Candidate *p1, const pat::Candidate *p2, string theFullName, string theName2);
  void Print();
...
class MyCommonHistograms {
 public:
  ...
  void Fill(const pat::Candidate *p);
  void Fill(const pat::Candidate *p1, const pat::Candidate *p2, string hName2);
