...
logDir=${workDir}"/BATCHJOBS/v4.h1/"
command "mkdir -p $logDir"

castorDirIn="/castor/cern.ch/cms/store/caf/user/tdahms/HeavyIons/Onia/Data2010/v4/Skims/Prompt/150256-150619/"

castorDirOut="/castor/cern.ch/cms/store/user/tdahms/HeavyIons/Onia/Data2010/v4/Histos/Prompt/150256-150619/h1/"
...
EOF
	...
	bsub -q 2nw -J $name /afs/cern.ch/user/t/tdahms/scratch0/HeavyIons2010/CMSSW_3_9_5/src/HiAnalysis/HiOnia/test/job_hionia_v2_${jobNb}.sh
